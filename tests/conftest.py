...
# WARNING: Ensure imports from `ah_datahub_szapi` comes after this line
from ah_datahub_szapi import app, settings, db  # noqa
from ah_datahub_szapi.cli import create_user, cli  # noqa
